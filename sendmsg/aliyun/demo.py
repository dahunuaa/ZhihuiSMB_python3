# -*- coding: utf-8 -*-
import sys
from sendmsg.aliyun.aliyunsdkdysmsapi.request.v20170525 import SendSmsRequest
from sendmsg.aliyun.aliyunsdkdysmsapi.request.v20170525 import QuerySendDetailsRequest
...
ACCESS_KEY_ID = "LTAI97DpcxurRE2O"
ACCESS_KEY_SECRET = "4xv5NQz03Cakk7MKVqcW5EJomwouZy"
...
if __name__ == 'send':
    ...
    # print(__business_id)
    params = {"name":"dahu"}
    print(send_sms(__business_id, "18752036998", "VCT快反系统", "SMS_85465026", params))

if __name__ == 'query':
    print(query_send_detail("", "18752036998", 10, 1, "20170814"))
