...
from ZhihuiSMB.bootstrap import exceptions
from ZhihuiSMB.libs import utils
from ZhihuiSMB.libs.oauthlib import validate_token
from ZhihuiSMB.libs.asynclib import AsyncUtils
...
try:
    ...
    from ZhihuiSMB.libs import importlib
...
class APIHandler(BaseAPIHandler):
    ...
    def finish(self, chunk=None, notification=None, origin=False, status_code=200):
        ...
        if callback:
            ...
            self.set_header("Content-Type", "application/json; charset=UTF-8")
            self.set_header("Server", "ZhihuiSMB API server/v0.1.0")
