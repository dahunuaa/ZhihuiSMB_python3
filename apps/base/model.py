...
import ZhihuiSMB.libs.mongolib as mongo
...
from ZhihuiSMB.libs.datatypelib import StrDT, DataTypeError, DatetimeDT
from ZhihuiSMB.libs.configlib import Config, ConfigList
from ZhihuiSMB.libs.options import config as base_config
...
class BaseModel(object):
    ...
    def get_model(cls, model_name):
        try:
            ...
            model_name = 'ZhihuiSMB.apps.%s.model' % (app_name)
